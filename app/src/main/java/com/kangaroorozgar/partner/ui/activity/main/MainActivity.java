...
import com.kangaroorozgar.partner.common.ChatHeadService;
import com.kangaroorozgar.partner.common.Constants;
import com.kangaroorozgar.partner.common.GPSTracker;
import com.kangaroorozgar.partner.common.LocaleHelper;
import com.kangaroorozgar.partner.common.PolyUtil;
...
import com.kangaroorozgar.partner.common.fcm.MyFireBaseMessagingService;
import com.kangaroorozgar.partner.common.swipe_button.SwipeButton;
import com.kangaroorozgar.partner.data.network.model.LatLngFireBaseDB;
...
import com.kangaroorozgar.partner.ui.activity.earnings.EarningsActivity;
import com.kangaroorozgar.partner.ui.activity.help.HelpActivity;
import com.kangaroorozgar.partner.ui.activity.instant_ride.InstantRideActivity;
import com.kangaroorozgar.partner.ui.activity.invite.InviteActivity;
import com.kangaroorozgar.partner.ui.activity.invite_friend.InviteFriendActivity;
import com.kangaroorozgar.partner.ui.activity.notification_manager.NotificationManagerActivity;
import com.kangaroorozgar.partner.ui.activity.profile.ProfileActivity;
import com.kangaroorozgar.partner.ui.activity.setting.SettingsActivity;
import com.kangaroorozgar.partner.ui.activity.summary.SummaryActivity;
import com.kangaroorozgar.partner.ui.activity.wallet.WalletActivity;
import com.kangaroorozgar.partner.ui.activity.your_trips.YourTripActivity;
...
import com.kangaroorozgar.partner.ui.fragment.navigation.NavigationFragment;
...
import static com.kangaroorozgar.partner.MvpApplication.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.kangaroorozgar.partner.MvpApplication.canGoToChatScreen;
import static com.kangaroorozgar.partner.MvpApplication.isChatScreenOpen;
import static com.kangaroorozgar.partner.MvpApplication.mLastKnownLocation;
import static com.kangaroorozgar.partner.common.Constants.checkStatus.ARRIVED;
import static com.kangaroorozgar.partner.common.Constants.checkStatus.EMPTY;
import static com.kangaroorozgar.partner.common.Constants.checkStatus.PICKEDUP;
import static com.kangaroorozgar.partner.common.Constants.checkStatus.STARTED;
import static com.kangaroorozgar.partner.common.Constants.userAvatar;
...
//                Intent intent = new Intent(this, DocumentActivity.class);
    ...
    public void onSuccess(UserResponse user) {
        if (user != null) {
            ...
            SharedHelper.putKey(this, Constants.SharedPref.CURRENCY, user.getCurrency());
            SharedHelper.putKey(this, Constants.SharedPref.SERVICE_TYPE, user.getService().getServiceTypeId());
