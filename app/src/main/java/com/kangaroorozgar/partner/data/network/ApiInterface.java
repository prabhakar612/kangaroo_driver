...
import com.kangaroorozgar.partner.data.network.model.City;
...
import com.kangaroorozgar.partner.data.network.model.State;
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @GET("/api/provider/add/money")
    Observable<List<ServerStartWalletResponse>> getServerStartWallet(@Query("user_type") String userType,
    ...
    @FormUrlEncoded
    @POST("api/provider/check/money")
    Observable<MoneyResponse> checkMoney(@FieldMap HashMap<String, Object> params);
}
